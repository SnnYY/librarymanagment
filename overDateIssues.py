...
def ViewOverDateIssues(): 
    ...
    headingLabel = Label(headingFrame1, text="Over Date Issues", bg='black', fg='white', font=('Courier',15))
    ...
    getBooks = "SELECT * FROM books_issued WHERE return_date < GETDATE() ORDER BY return_date DESC "
    try:
